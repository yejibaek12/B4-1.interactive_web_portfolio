...
### 2. 미디어 쿼리를 활용한 모바일 퍼스트 반응형 레이아웃
...
### 3. 로컬스토리지 연동 다크 모드 (LocalStorage Persistent Theme)
...
### 7. GitHub REST API 비동기 처리 및 4가지 UI 상태 제어
